...
public class AddCourses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String coursesDomain=request.getParameter("coursesDomain");
        Courses courses=new Courses();
        courses.setCourse_name(coursesName);
        courses.setCredit(credit);
        courses.setDescription(coursesDescription);
        courses.setDomain(coursesDomain);
